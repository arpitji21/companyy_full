  ...
  head: () => ({
    meta: [
      ...
      { title: "LarkAI Orbit — Enterprise Intelligence Platform" },
      {
        name: "description",
        content:
          "Orbit unifies every department of Lark Healthcare into one AI-governed enterprise operating layer.",
      },
      { name: "author", content: "Lark Healthcare" },
      { property: "og:title", content: "LarkAI Orbit — Enterprise Intelligence Platform" },
      {
        property: "og:description",
        content:
          "One system. Every department. AI agents grounded in your live enterprise data.",
      },
